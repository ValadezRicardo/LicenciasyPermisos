...
function create($user){
    ...
    $q=execQueryP("INSERT INTO usuariop(usuario,nombre,contrasena,email,telefono,rol_id) 
...
function delete($user){ 
    $id=$user['id'];
    $q=execQueryP("DELETE FROM usuariop WHERE id=$id");
    //$q=execQueryP("UPDATE usuariop SET deleted=1 WHERE id=$id");
}
...
function update($user){
    ...
    $rol_id=$user["rol_id"];
    if($user["contrasena"] !=''){
    $q=execQueryP("UPDATE usuariop SET usuario='$usuario', nombre='$nombre', contrasena='$contrasena',
     email='$email',telefono='$telefono', rol_id='$rol_id' WHERE id=$id");
    }
    else{
    $q=execQueryP("UPDATE usuariop SET usuario='$usuario', nombre='$nombre',
     email='$email',telefono='$telefono', rol_id='$rol_id' WHERE id=$id");
    }
...
<!--      <h2>PLATAFORMA PERMISOS</h2>
      ...
      <p class="mt-2 mb-5">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>-->
        <table id="FoliosLicencias" class="display table table-striped" style="width:100%">
            ...
            <tbody>
            <?php
                 $q=execQueryP("select * from usuariop");
    ...
    <section class="mb-5">
        <h2>NUEVO USUARIO</h2>
<!--        <h3>USUARIO QUE PUEDE VER ESTA SECCIÓN: SUPERADMIN</h3>-->
        <form class="my-5" action="usuariosp.php?a=c"  method="POST">
    ...
    <form action="usuariosp.php?a=d" style="display:none;"  method="POST"> 
    ...
    <div class="modal fade" id="EditModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-body">
                <form class="my-5" action="usuariosp.php?a=u"  method="POST">
